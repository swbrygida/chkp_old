...
<section>
    ...
    <p>W wyniku przeprowadzonych prac świątynia pełni też nowe funkcje: edukacyjną, kulturalną i turystyczną: kaplica grunwaldzka, sanktuarium św. Brygidy, Lubelskie Sanktuarium Pamięci Narodowej, ekspozycja historyczna, numizmatyczna i archeologiczna w wieży kościoła z chórem i kryptach.</p>
    <p>Ten obiekt łączy w sobie dwa style: gotyk i renesans lubelski. Na przykładzie zabytkowego obiektu można wykazać cechy charakterystyczne dla poszczególnego stylu architektonicznego i jego przenikania do istniejących już budowli. Zwiedzając zabytkowy obiekt można poznać historię tego miejsca związanego z Grunwaldem, historię Lublina i piękno architektury gotyckiej i renesansowej ukryte w tych murach, którego bogate wnętrze było wielokrotnie przebudowywane i przykryte kolejnymi warstwami tynku i farby.</p>
    <p>Zrewitalizowanym obiekt jest także miejscem do zaprezentowania szerokiej i bogatej oferty koncertowej w ramach cyklu: „Wieczory muzyczne w Kościele Pobrygidkowskim”.</p>
    <p>Obecnie obiekt sakralny – królewskie wotum pełni funkcje:</p>
    <ul>
    <li>dydaktyczną, edukacyjną jako źródło wiedzy historycznej oraz bogactwa stylów architektonicznych charakterystycznych dla poszczególnych epok w historii Polski, oraz jako „lekcja historii” o dążeniu Polaków do niepodległości (Lubelskie Sanktuarium Pamięci Narodowej),</li>
    <li>kulturalną i turystyczną – atrakcyjna oferta turystyczna, którą podziwiają zwiedzający nie tylko z naszego Regionu ale całej Polski i spoza jej granic. Przeprowadzone prace renowacyjne ukazują bogactwo ukryte w tym pomniku – wotum króla Władysława Jagiełły.</li>
    </ul>
    <p><strong>Przeprowadzone prace miały na celu</strong> zwiększenie atrakcyjności inwestycyjnej regionu oraz poprawę warunków życia mieszkańców poprzez renowację pobrygidkowskiego zespołu klasztornego w Śródmieściu miasta Lublina.</p>
    <p>Prace konserwatorsko restauratorskie przyczyniły się do:</p>
    <ul>
    <li>przywrócenia wartości historycznej wotum króla Władysława Jagiełły za zwycięstwo w bitwie pod Grunwaldem, ,</li>
    <li>przystosowania zespołu klasztornego do pełnienia nowych funkcji społecznych i turystyczno – kulturalnych,</li>
    <li>poprawy dostępności turystycznej do zabytkowego obiektu,</li>
    <li>poprawy ładu przestrzennego i uporządkowanie przestrzeni publicznej śródmieścia Lublina,</li>
    <li>poprawy poziomu bezpieczeństwa na terenie rewitalizowanego zespołu klasztornego i w jego otoczeniu.</li>
    </ul>
  </section>
    <section>
  ...
  <section>
    <p>W roku 2012 minęło 600. lat od rozpoczęcia budowy zespołu pobrygidkowskiego w Lublinie, w skład którego wchodzą kościół oraz klasztor, a w roku 2026 będziemy obchodzić jubileusz 600 – lecia zakończenia budowy królewskiego wotum wdzięczności.</p>
    <p>Ko­ściół pw. Wniebowzięcia NMP Zwycięskiej w Lublinie wraz z klasz­torem został ufundowany przez króla Władysława Jagiełłę jako wotum dziękczynne za zwycięstwo w bitwie pod Grunwaldem. Tradycja utrzymuje, że przy jego budowie w latach 1412-1426 pra­cowali jeńcy krzyżaccy. Odpowiedni dokument fundacyjny król wydał 1 kwietnia 1426 roku w Krasnymstawie.</p>
    <p>Po ukończeniu prac król Władysław Jagiełło sprowadził zakon założony przez św. Brygidę, która przepowiedziała upadek Krzyżaków.</p>
    <p>Duchowe dziedzictwo św. Brygidy, którą św. Jan Paweł II ogłosił 1 października 1999 r. współpatronką Europy, zo­bowiązuje do odpowiedzialności za europejską wspólnotę ducha.</p>
    <p>Mając na uwadze historyczne, kulturowe i artystyczne znaczenie dziedzictwa narodowego oraz potrzebę godnego uczczenia kolejnych rocznic ważnych wydarzeń z historii naszej wspólnoty, w latach 2011-12 został zrealizowany projekt pod nazwą: „Renowacja pobrygid<strong>kowskiego zespołu</strong> klasztornego w Śródmieściu miasta Lublina.</p>
    <p>Na te jubileusze nie planowaliśmy wznosić nowych pomników. Wspólnym darem jest dzieło renowacji świątyni, która odzyskała dawany blask i ukryte piękno.</p>
    <p>W związku z realizacją projektu pn. Renowacja zespołu pobrygidkowskiego śródmieściu miasta Lublina, zostały wprowadzone w zabytkowym obiekcie nowe funkcje: edukacyjne, kulturalne i turystyczne. Utworzono: kaplicę grunwaldzką, sanktuarium św. Brygidy, Lubelskie Sanktuarium Pamięci Narodowej oraz ekspozycje historyczna, numizmatyczna i archeologiczna w wieży kościoła z chórem i kryptach.</p>
  </section>
    <section>
  ...
  <section>
    <p>W wyniku realizacji projektu pn. Renowacja zespołu pobrygidkowskiego śródmieściu miasta Lublina wprowadzono w zabytkowym obiekcie nowe funkcje: edukacyjne, kulturalne i turystyczne i utworzono: kaplicę grunwaldzką, sanktuarium św. Brygidy, Lubelskie Sanktuarium Pamięci Narodowej oraz ekspozycje historyczna, numizmatyczna i archeologiczna w wieży kościoła z chórem i kryptach.</p>
    <p><strong>– Kaplica Grunwaldzka</strong></p>
    <p>Kaplica Grunwaldzka – Kaplica św. Judy Tadeusza zastępuje niejako brakującą w tym układzie architektonicznym kościoła nawę boczną wraz z dobudowaną w XVII wieku czworokątna wieżą- dzwonnicą. Nadano jej tytuł Kaplicy Grunwaldzkiej, ze względu na stiukowe popiersie Króla-Fundatora Kościoła Władysława Jagiełły. Pod tym Popiersiem znajduje się granitowa tablica z napisem:</p>
    <p><strong>ŚWIĄTYNIĘ TĘ WZNIÓSŁ</strong></p>
    <p><strong>KRÓL WŁADYSŁAW JAGIEŁŁO</strong></p>
    <p><strong>NA PAMIĄTKĘ ZWYCIĘSTWA ODNIESIONEGO</strong></p>
    ...
    <p>Obrazy wraz z ołtarzem bocznym zostały w maju 2012r. przewiezione do pracowni konserwatorskiej w celu przeprowadzenia renowacji. Odnowione zabytki ruchome powróciły na swoje miejsce na uroczystości jubileuszowe 600-lecia rozpoczęcia budowy królewskiego wotum, przypadające w 2012r.</p>
  </section>
    <section>
    ...
    <p>Remont więźby dachowej z wymianą pokrycia dachu kaplicy św. Judy Tadeusza wraz z zakrystią i „łącznikiem” został przeprowadzony dzięki dotacji przyznanej przez Ministerstwo Kultury i Dziedzictwa Narodowego w 2012r.</p>
  </section>
    <section>
    ...
    <p><strong>W Sanktuarium św. Brygidy w pobliżu wejścia głównego – ma miejsce także ekspozycja archeologiczna starych murów.</strong> Badanie georadarem wykazało obecność starych murów – pozostałości po kaplicy starszej od kościoła – pod posadzką w północno-zachodniej części nawy głównej. Wykonano więc podświetloną ekspozycję tych murów poprzez wykonanie przeszklonego otworu (szkło laminowane posadzkowe) w posadzce umożliwiającego oglądanie pozostałości istniejącej już w 1396r. starej kaplicy Najświętszej Maryi Panny, św. Zofii i św. Barbary.</p>
  </section>
    <section>
    ...
    <p>W okresie powojennym był miejscem tętniącym wolnością od reżimu komunistycznego, kolebką lubelskiej Solidarności. Po dziś dzień wiele uroczystości państwowych, patriotycznych rozpoczyna się Mszą świętą w tym właśnie kościele.</p>
    <p>Długa jest historia Mszy świętych za Ojczyznę, sięga lat 70-tych i jej założyciela, ówczesnego rektora ks. Mieczysława Brzozowskiego. Jedna z tablic pamiątkowym poświęcona jest Jego osobie.</p>
    <p>Wśród innych tablic znajdziemy te dedykowane Marszałkowi Józefowi Piłsudskiemu, Orlętom Lwowskim, generałowi brygady Kazimierzowi Tumidajskiemu, generałowi brygady Mieczysławowi Smorawińskiemu, żołnierzom AK, zamordowanym podczas II wojny światowej: w ogniu walk i w obozach kaźni na wschodzie: w Katyniu, Miednoje i Charkowie.</p>
    ...
    <p>Dzięki XVIII-wiecznej dobudowie muru od strony południowej nawa posiada dodatkowe wejście boczne z przedsionkiem. Przy bocznym wejściu została zamontowana platforma dla osób niepełnosprawnych.</p>
  </section>
    <section>
