<template id="">
  <Layout>
    ...
    <p>W gablotach dominuje wizerunek św. Ignacego Loyoli, założyciela zakonu Jezuitów. Św. Ignacy Loyola, często przedstawiany jest na jednym medaliku ze św. Franciszkiem Ksawerym – współzałożycielem zakonu jezuitów.</p>
    <p>W drugiej gablocie, oprócz owalnych medalików zobaczymy także egzemplarz w kształcie tarczy. Na nim znajduje się wizerunek Maryi z Jezusem oraz Świętego Leonarda z Limoges – rycerza i pustelnika. Poniżej umieszczony został zabytek opisany jako „cudowny medalik”, nazywany także jako <em>Medalik Niepokalanego Poczęcia</em>.</p>
    ...
    <section>
    <p><strong>EKSPOZYCJA ARCHEOLOGICZNA W KAPLICY GRUNAWLDZKIEJ</strong>**(ŚW. JUDY TADEUSZA)**</p>
    <p>Krypta w kaplicy Grunwaldzkiej (kaplica św. Judy Tadeusza)  wyróżnia się na tle pozostałych kamienną konstrukcją ścian i sklepień. Jednak zejście tu, z racji gabarytów, jakiejkolwiek osoby byłoby niebezpieczne, czy wręcz niemożliwe. Dlatego uczytelniony i zakonserwowany korytarz wejściowy przykryty został taflą szklaną, przez którą możliwy jest wgląd do wnętrza pomieszczenia. Odpowiednie podświetlenie, z perspektywy posadzki świątyni pozwala dostrzec kunszt kamieniarski mistrzów, którzy wznieśli tę salę.</p>
    <p>W ramach aranżacji wnętrza krypty umieszczono trumny. W tej sali spoczywały sarkofagi sióstr Wizytek – wobec braku dobrze zachowanych trumien, zostały umieszczone rekonstrukcje wraz z odtworzeniem epitafiów. Na jednym poziomie ustawiono dwa pochówki, tak jak to zarejestrowano w czasie prac archeologicznych. Umieszczono kamery, która umożliwia dokładniejsze oglądanie wnętrza. Monitor jest zlokalizowany w wieży kościoła.</p>
  </section>
    <section>
    <p><strong>EKSPOZYCJA ARCHEOLOGICZNA KRYPTY W NAWIE BOCZNEJ</strong></p>
    <p>Ostatnią krypta, którą można została przeznaczona na cele wystawiennicze, jest krypta w nawie bocznej. W czasie prac archeologicznych zostało odsłonięte wejście do niej, a w dalszej kolejności wybrana była ziemia przemieszana z gruzem, która wypełniała całą podziemną przestrzeń. Poniżej niej, nadal zalega poziom lessu przemieszanego ze szczątkami ludzkimi oraz elementami wyposażenia trumien.</p>
    <p>W trakcie prac archeologicznych odsłonięta została także klatka schodowa, dla potrzeb ekspozycji, historyczne wejście zostało odpowiednio zabezpieczone i wzmocnione. Natomiast we wnętrzu wystawiono zrekonstruowane trumny sióstr Brygidek oraz Wizytek. Kondycja sarkofagów nie pozwalała na ich konserwację i przeznaczenie do celów ekspozycyjnych. Jednak zebrane dane pozwoliły na wykonanie ich wiernych kopii, łącznie z odtworzeniem kształtu oraz sposobu zdobienia, w tym szczególnie epitafiów. Z uwagi na ilość miejsca oraz dostępność dla turystów wyeksponowano trzy trumny, które można dostrzec z powierzchni kościoła.</p>
  </section>
