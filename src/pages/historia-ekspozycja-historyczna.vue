<template id="">
  ...
  <section>
    ...
    <p>Pozostałe tablice znajdują się we wnętrzach kaplic i na wewnętrznych stronach filarów oddzielających kaplice w bocznej nawie kościoła, po stronie południowej.</p>
    <p>W kaplicy położonej najbliżej prezbiterium umieszczono tablice poświęcone:</p>
  </section>
    <section>
  <p>  1. Marszałkowi Józefowi Piłsudskiemu</p>
    ...
    3. Żołnierzom Armii Krajowej i gen. Kazimierzowi Tumidajskiemu<br>
    4. Żołnierzom Armii Krajowej więzionym w okresie powojennym<br>
    5. Ks. Aleksandrowi Bohdanowiczowi</p>
  </section>
    <section>
    ...
    4. Ks. Stefana Młynarczyka, rektora kościoła w latach 1969 – 1976<br>
    5. Ks. Mieczysława Brzozowskiego, rektora kościoła w latach 1976 – 1982<br>
    6. Siostry Emilii Szerwendke, urszulanki<br>
    7. Władysława Brolla<br>
    8. Marianny Trzcińskiej O tej tablicy wspomina już na początku XX wieku ks. J. A. Wadowski.</p>
    ...
    4. Remont świątyni 1934 r.<br>
    5. Nawiedzenie kopii Obrazu Matki Bożej Częstochowskiej 2004<br>
    6. Renowacja pobrygidowskiego zespołu klasztornego w Śródmieściu miasta Lublina 2011- 2012.</p>
  </section>
    <section>
    ...
    <p>Trzeci poziom ekspozycji wieży prezentuje konstrukcję pod 2 dzwony: duży i mały. Dzwon duży (1 połowa XVIIIw.)  w kształcie odwróconego kielicha, z koroną z sześcioma uszami. Ozdobiony wieńcem dekoracyjnym ze stylizowanymi łacińskimi literami oraz wizerunkiem Matki Boskiej Niepokalanie Poczętej.</p>
  </section>
    <section>
    ...
    <p>Cytowany na początku niniejszego opracowania ks. J. A. Wadowski wyrażał życzenie, aby Opatrzność pozwoliła jaszcze długie lata cieszyć się narodowi kościołem pw. Wniebowzięcia NMP (por. Wstęp).</p>
    <p>Wydarzenia wieku XX. sprawiły, że świątynia pobrygidkowska stała się miejscem modlitwy za Ojczyznę i naród polski oraz swoistym „panteonem” dla tych którzy oddali swoje życie za wolność i niepodległość Polski.</p>
    <p>Po przeprowadzonych w ostatnich latach pracach kościół odzyskał na nowo blask i świeżość, odsłaniając jednocześnie wiele tajemnic. Dobrze, że ważne z punktu widzenia historii sztuki zabytki, dotąd trudno dostępne, bądź nieodkryte, mogą obecnie cieszyć sobą większą liczbę wiernych Kościoła, miłośników historii, mieszkańców naszego miasta i przybywających turystów. Nowoczesna ekspozycja tym bardziej pozwoli je przybliżyć szerokiej publiczności i przyczyni się do jeszcze lepszej ochrony skarbów naszej narodowej kultury.</p>
    </section>
